...
I_H= 1e-12; %1e-8 risk allocated to unmonitored fault modes
P_UA= 1e-9;
min_n_L_M= 15; % min number of landmarks in preceding horizon
...
sig_lidar= 0.20; % 25cm -- lidar measurement in the nav frame (it was 0.2 OSAMA)
...
threshold_new_landmark= 20; % Threshold in NIS to create a new landmark
...
sig_velocity_sim= 0.1; % [m/s]
sig_steering_angle_sim= deg2rad(0.4); % [rad]  (it was deg2rad(2) OSAMA)
wheelbase_sim= 1; % for the simulated car
% way_points= [[10;-5], [40;-20], [70;0], [40;20], [10;5], [0;0]];
% way_points= [ [50;-20], [100;-20], [100;20], [50; 20], [0;0]];
way_points= [ [40;-20], [80;20], [120;-20], [160;20], [200;0], [160;-20], [120;20], [80;-20], [40;20], [0;0]];
% way_points= [ [30;20], [60;-20], [90;20], [120;-20], [150;0]];
% way_points= [ [75;40], [150;0], [75;-40], [0;0], [75;40], [150;0], [75;-40], [0;0], [75;40], [150;0], [75;-40], [0;0], [75;40], [150;0], [75;-40], [0;0] ];
...
sig_gyro_z= deg2rad(2); % [rad/s]  standard dev of the gyro (it was deg2rad(3) OSAMA)
% map_limits= [-25, 230, -50, 50]; % [x_min, x_max, y_min,  y_max] 
% map_limits= [-40, 190, -40, 40]; % [x_min, x_max, y_min,  y_max] 
map_limits= [-10, 210, -30, 30]; % [x_min, x_max, y_min,  y_max] 
