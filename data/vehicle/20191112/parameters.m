...
sig_lidar= 0.6; % 25cm -- lidar measurement in the nav frame
...
sig_minLM= 0.3; % minimum SD for the landmarks
mult_factor_acc_imu= 500; % multiplicative factor for the accel SD
mult_factor_gyro_imu= 500; % multiplicative factor for the gyros SD
...
initial_yaw_angle= -180; % [deg] initial yaw angle (different for each experiment) % smooth_turn(180)
