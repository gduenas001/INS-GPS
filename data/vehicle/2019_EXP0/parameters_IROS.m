...
P_UA= 1e-3;
I_H= 1e-12;
min_n_L_M= 120; % min number of landmarks in the preceding horizon + current time
...
mult_factor_acc_imu= 10; % (default 10) multiplicative factor for the accel SD
mult_factor_gyro_imu= 10; % (default 10) multiplicative factor for the gyros SD
...
initial_yaw_angle= 0;%-90; % [deg] initial yaw angle (different for each experiment) % smooth_turn(180)
