...
% create objects
params= ParametersClass("gazebo_fg_offline_CS_MA");
...
FG.pose= data.pose';
clear data
estimator= EstimatorClassFgGazeboOffCSMA(params);
im= IntegrityMonitoringClassFgGazeboOffCSMA(params, estimator);
