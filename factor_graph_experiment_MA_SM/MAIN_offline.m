...
% create objects
params= ParametersClass("experiment_fg_offline_MA_SM");
load([params.path, 'FG.mat']); % organized experimental data (preprocessing using KF)
estimator= EstimatorClassFgExpOffMASM(params);
im= IntegrityMonitoringClassFgExpOffMASM(params, estimator);
...
%------------------------------------------------------------
save('30_01_2020_corrected_paper_w_MA.mat');