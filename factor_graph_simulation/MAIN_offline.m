...
% create objects
params= ParametersClass("simulation_fg_offline",lm_dens(ind_lm_dens));
estimator= EstimatorClassFgSimOff(params);
im= IntegrityMonitoringClassFgSimOff(params, estimator);
