...
%save(['PLANS_P_MA_example_',num2str(lm_dens(ind_lm_dens)),'_two_simult_faults_n_max_2_corrected_paper_without_MA.mat']);
save(['PLANS_P_MA_example_',num2str(lm_dens(ind_lm_dens)),'_two_simult_faults_n_max_2_corrected_scratch_without_MA.mat']);
% save workspace
