...
%lm_dens=0.003:0.005:0.025;
lm_dens=linspace(0.0025 ,0.025,10);
...
% create objects
params= ParametersClass("simulation_fg_online_SS",lm_dens(ind_lm_dens));
estimator= EstimatorClassFgSimOnSS([], params);
