...
sampled_mean = [mean(Prior_State(:,1)), mean(Prior_State(:,2))];
plot(sampled_mean(1),sampled_mean(2),'ro','LineWidth',2)
...
plot(weighted_mean(1),weighted_mean(2),'co','LineWidth',2)
