...
classdef EstimatorClassEkfExpSM < handle
    ...
    properties
        ...
        appearances= zeros(1,600); % if there are more than 300 landmarks, something's wrong
    ...
    methods
        % ----------------------------------------------
        % ----------------------------------------------
        function obj= EstimatorClassEkfExpSM(imu_calibration_msmts, params)
