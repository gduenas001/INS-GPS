...
if params.SWITCH_OFFLINE
     [obj.Phi_k, obj.D_bar, obj.H_state]= obj.return_Phi_and_D_bar(obj.x_true, vel, phi, params);
    ...
    [obj.Phi_k, obj.D_bar, obj.D_bar_ub]= obj.return_Phi_and_D_bar(obj.XX, vel, phi, params);
...
if ~params.SWITCH_FACTOR_GRAPHS
    % predict covariance
    obj.PX_ub= obj.Phi_k * obj.PX * obj.Phi_k' + obj.D_bar_ub;
