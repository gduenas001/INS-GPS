...
classdef EstimatorClassFgSimOnMA < handle
    ...
    properties
        ...
        association_true_ph % true associations during the ph
    ...
    methods
        % ----------------------------------------------
        % ----------------------------------------------
        function obj= EstimatorClassFgSimOnMA(imu_calibration_msmts, params)
            ...
            if params.SWITCH_FIXED_LM_SIZE_PH
                ...
                obj.association_true_ph= cell(1, params.M);
