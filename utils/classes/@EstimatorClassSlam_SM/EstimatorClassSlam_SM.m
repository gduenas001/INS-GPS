...
classdef EstimatorClassSlam_SM < handle
    ...
    properties
        ...
        appearances= zeros(1,2000); % if there are more than 300 landmarks, something's wrong
    ...
    methods
        % ----------------------------------------------
        % ----------------------------------------------
        function obj= EstimatorClassSlam_SM(imu_calibration_msmts, params)
