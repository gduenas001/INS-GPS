...
classdef IntegrityMonitoringClassEkfSimLinErr < handle
    properties (Constant)
        m= 3
    ...
    methods
        % ----------------------------------------------
        % ----------------------------------------------
        function obj= IntegrityMonitoringClassEkfSimLinErr(params, estimator)
            ...
            obj.Lpp_ph_ub=cell(1, params.M + 1); % need an extra epoch here (osama)
