...
if  ( params.SWITCH_FIXED_LM_SIZE_PH &&...
    ...
    % detector threshold
    obj.T_d= chi2inv( 1 - params.continuity_requirement , obj.n_M );
...
%                 end
                ...
                if abs(obj.optimization_fn(...
                        0, fx_hat_dir_ub, M_dir_ub, obj.sigma_hat_ub, params.alert_limit, obj.n_M + obj.n_M_gps )) > 1e-10
                    % worst-case fault magnitude
                    f_mag_min= 0;
                    f_mag_max= 5;
                    f_mag_inc= 5;
                    ...
                    for k= 1:10
                        [f_M_mag_out, p_hmi_H_ub]= fminbnd( @(f_M_mag) obj.optimization_fn(...
                            f_M_mag, fx_hat_dir_ub, M_dir_ub, obj.sigma_hat_ub, params.alert_limit, obj.n_M + obj.n_M_gps ),...
                            f_mag_min, f_mag_max);
    ...
    if obj.p_hmi >= 1, obj.p_hmi = 1; end
    if obj.p_hmi_ub >= 1, obj.p_hmi_ub = 1; end
