...
classdef IntegrityMonitoringClassFgGazeboOffCSMA < handle
    properties (Constant)
        m= 3
    ...
    properties
        ...
        lidar_msmt_ind
        gps_msmt_ind
        n_gps_ph =0% number of gps msmt at each epoch in PH
        H_gps_ph=0
        H_lidar_ph
        n_M_gps=0
        A_reduced
    ...
    methods
        % ----------------------------------------------
        % ----------------------------------------------
        function obj= IntegrityMonitoringClassFgGazeboOffCSMA(params, estimator)
