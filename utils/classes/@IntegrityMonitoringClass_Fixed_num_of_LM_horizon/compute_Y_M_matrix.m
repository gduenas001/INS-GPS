...
if isempty(obj.Y_M)
    obj.Y_M= zeros( obj.n_M_for_LM, obj.n_M_for_LM );
    ...
    obj.Y_M= [ estimator.Y_k, zeros(estimator.n_k,sum(obj.n_ph(1:obj.M_for_LM))) ;...
               zeros(sum(obj.n_ph(1:obj.M_for_LM)),estimator.n_k), obj.Y_M(1:sum(obj.n_ph(1:obj.M_for_LM)), 1:sum(obj.n_ph(1:obj.M_for_LM)))];
end
end